...
export class MemberService {
	constructor(
		...
		@InjectModel('Follow') private readonly followModul: Model<Follower | Following>,
	...
	private async checkSubscription(followerId: ObjectId, followingId: ObjectId): Promise<MeFollowed[]> {
		const result = await this.followModul.findOne({ followingId: followingId, followerId: followerId }).exec();
	...
	public async likeTargetMember(memberId: ObjectId, likeRefId: ObjectId): Promise<Member> {
		...
		const result = await this.memberStatusEditor({ _id: likeRefId, targetKey: 'memberLikes', modifier: modifer });
